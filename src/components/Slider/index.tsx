        ...
        {data.slides.map((slide, index) => {
          return (
            <div
              className={
                index === currentSlide
                  ? "flex transition-opacity duration-700 ease-in-out"
                  : "opacity 0 hidden"
              }
              key={index}
            >
              <div className={`w-full relative `}>
                <div className={`w-full`}>
                  <div
                    className={`flex h-[500px] w-screen  max-w-full md:h-[700px] bg-cover bg-center`}
            ...
            >
              <div className="relative w-full flex items-center justify-center">
                <Icon
                  ...
                  className="h-4 w-4 md:w-8 md:h-8 text-white"
                />
              </div>
            </button>
